    ...
    <div class="edit-container">
        <div class="card edit-card">
            <div class="card-header">
                <h1 class="mb-0">✏️ Editar Producto</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('products.update', $product) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control input-modern">{{ old('description', $product->description) }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="branch_id" class="form-control input-modern" 
                               value="{{ old('branch_id', $product->branch_id) }}" required>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-success btn-modern">💾 Actualizar</button>
